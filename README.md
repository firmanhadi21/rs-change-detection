...
|----------|--------|--------|
| `smoke-track` | Lintasan asap: parsel udara dari titik api dibawa angin ERA5 100 m (MovingPandas) → kipas lintasan + daftar kabupaten terlintasi. **ILUSTRASI, bukan atribusi** — untuk klaim yang harus tahan uji, pakai HYSPLIT/FLEXPART. Perlu `pip install 'earthchange[track]'` | ERA5 + FIRMS + CAMS |
