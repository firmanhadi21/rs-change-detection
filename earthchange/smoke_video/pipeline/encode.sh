...
# Output basename. Was hardcoded to "ketapang_wildfire_smoke", so every region
# produced files named after Kalimantan — a Bromo run wrote ketapang_*.mp4.
NAME="${OUT_NAME:-wildfire_smoke}"
